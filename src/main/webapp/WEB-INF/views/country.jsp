	...
	<div class="container mt-5">
		...
		<div class="card">
			<div class="card-header">
				<div class="h3 text-primary">Country Data Form</div>
			</div>
			<div class="card-body">
				<div class="container">
					<form action="./save-country" method="post">
					<input type="hidden" name="id" id="id" value="${co.id}">
					<div class="row">					
						<div>
							<label for="countryId">Country Name</label>
							<input type="text" id="name" name="name" class="form-control" value="${co.name}">
						</div>						
					</div>
			...
			<tbody>
				<c:forEach items="${countries}" var="c" varStatus="counter">
					<tr>
						...
						<td>${c.name}</td>
						<td>
							<a href="./delete-country?cId=${c.id}" class="text-danger">Del</a> | 
							<a href="./update-country?cId=${c.id}" class="text-warning">Update</a>
						</td>					
					</tr>			
				</c:forEach>
